<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=32&duration=2800&pause=2000&color=00D9FF&center=true&vCenter=true&width=940&lines=Hi+%F0%9F%91%8B+I'm+谢白羽;游戏后端开发+%2B+AI工程师;C%2FC%2B%2B+%7C+Python+%7C+CUDA;66万+博客访问+%7C+438+原创文章" alt="Typing SVG" />
</div>
...
public:
    string name = "谢白羽";
    string role = "游戏后端开发 & AI工程师";
    int coding_years = 7;
    
    vector<string> tech_stack = {
        "C/C++", "Python", "CUDA", "TensorRT",
        "游戏后端", "大语言模型", "服务器开发"
    };
